...
import schoolClass from "@/parser/sssvt/class";
import getDate from "@/parser/sssvt/date";

/**
 * Scrape the data from the substitution schedule
 *
 * @param html The html to parse
 * @returns A SSSVT class with the parsed data
 */
async function parseSSSVT(html: string): Promise<SSSVT | null> {
